...
public class ConcatFilterTest {
    ...
    public void testFilterReaderNoArgs() throws IOException {
        ...
        File expected = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(),"input/concatfilter.test");
        File result = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(), "result/concat.FilterReaderNoArgs.test");
     ...
     */
    private void doTest(String target, String expectedStart, String expectedEnd) throws IOException {
        buildRule.executeTarget(target);
        String resultContent = FileUtilities.getFileContents(FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(),
                "result/concat." + target.substring(4) + ".test"));
