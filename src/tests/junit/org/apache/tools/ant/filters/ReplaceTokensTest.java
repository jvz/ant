...
public class ReplaceTokensTest {
    ...
    public void testReplaceTokens() throws IOException {
        ...
        File expected = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(),"expected/replacetokens.test");
        File result = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(),"result/replacetokens.test");
    ...
    public void testReplaceTokensPropertyFile() throws IOException {
        ...
        File expected = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(), "expected/replacetokens.test");
        File result = FILE_UTILS.resolveFile(buildRule.getProject().getBaseDir(), "result/replacetokensPropertyFile.test");
        assertTrue(FILE_UTILS.contentEquals(expected, result));
    }
